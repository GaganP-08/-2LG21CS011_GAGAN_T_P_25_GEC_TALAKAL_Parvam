...
import com.example.studentcrud.service.GaganEmployeeService;

@Controller
@RequestMapping("/gagan")

public class GaganEmployeeController {

    @Autowired
    private GaganEmployeeService employeeService;
